...
public enum StatusCode {
    ...
    CODE_10005("10005", "token会话已超时"), CODE_10006("10006", "token权限认证失败，没有访问权限"), CODE_10007("10007", "用户在别的地方登陆"), CODE_10008("10008", "访问过快，请稍候再试"), CODE_10010("10010", "业务请求失败（通用的异常提示状态码）"),
