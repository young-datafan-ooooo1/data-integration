...
public class TextFileInputReader implements IBaseFileInputReader {
  ...
  private final TextFileInputMeta2 meta;
  ...
  public TextFileInputReader(IBaseFileInputStepControl step, TextFileInputMeta2 meta, TextFileInputData data,
  ...
  public void close() {
    try {
      ...
      for (String tmpFile : meta.inputFiles.fileName) {
