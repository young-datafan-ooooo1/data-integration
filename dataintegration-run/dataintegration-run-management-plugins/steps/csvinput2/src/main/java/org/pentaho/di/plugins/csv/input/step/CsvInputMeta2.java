...
public class CsvInputMeta2 extends BaseStepMeta implements StepMetaInterface, InputFileMetaInterface,
  ...
  @Override
  public Object clone() {
    final CsvInputMeta2 retval = (CsvInputMeta2) super.clone();
  ...
  public String getXML() {
    ...
    retval.append("      ").append(XMLHandler.addTagValue(getXmlCode("FTP_USERNAME"), ftpUsername));
    retval.append("    ").append(XMLHandler.addTagValue(getXmlCode("FTP_PASSWORD"), ftpPassword));
    retval.append("    ").append(XMLHandler.addTagValue(getXmlCode("FILE_SERVER_TYPE"), fileServerType));
  ...
  public void readRep( Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases ) throws KettleException {
    try {
      ...
      ftpUsername = rep.getStepAttributeString(id_step, getRepCode("FTP_USERNAME"));
      ftpPassword = rep.getStepAttributeString(id_step, getRepCode("FTP_PASSWORD"));
      fileServerType = rep.getStepAttributeString(id_step, getRepCode("FILE_SERVER_TYPE"));
  ...
  public void saveRep( Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step ) throws KettleException {
    try {
      ...
      rep.saveStepAttribute(id_transformation, id_step, getRepCode("FTP_USERNAME"), ftpUsername);
      rep.saveStepAttribute(id_transformation, id_step, getRepCode("FTP_PASSWORD"), ftpPassword);
      rep.saveStepAttribute(id_transformation, id_step, getRepCode("FILE_SERVER_TYPE"), fileServerType);
  ...
  public void injectStepMetadataEntries( List<StepInjectionMetaEntry> metadata ) {
    for ( StepInjectionMetaEntry entry : metadata ) {
      ...
      if ( entry.getValueType() != ValueMetaInterface.TYPE_NONE ) {
        ...
        } else if ( attr.getKey().equals( "FTP_USERNAME" ) ) {
          ftpUsername = (String) entry.getValue();
        }else if ( attr.getKey().equals( "FTP_PASSWORD" ) ) {
          ftpPassword = (String) entry.getValue();
        }else if ( attr.getKey().equals( "FILE_SERVER_TYPE" ) ) {
          fileServerType = (String) entry.getValue();
        }else {
