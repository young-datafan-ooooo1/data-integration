<template>
  <div>
    <el-form :inline="true" class="demo-form-inline">
      ...
      <el-form-item>
        <el-button type="primary" size="small" v-if="btnShow" @click="editFile()">上传</el-button>
        <el-button type="primary" size="small" v-if="!btnShow" @click="editFile()">新增</el-button>
      </el-form-item>
    </el-form>
    ...
    <el-dialog title="新增分组" :visible.sync="addGroupViaiable" width="30%" :before-close="closeAdd" :close-on-click-modal='false'
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="closeAdd()">取 消3</el-button>
