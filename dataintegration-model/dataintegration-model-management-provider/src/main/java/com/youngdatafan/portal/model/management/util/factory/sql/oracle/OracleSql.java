package com.youngdatafan.portal.model.management.util.factory.sql.oracle;
 ...
 */
@Component
public class OracleSql extends CommonSqlFilter implements SqlJoin {
...
//            stringBuffer.append(basicModelMetaDataVO.getColumnName() + " as \"" + basicModelMetaDataVO.getColumnChineseName() + "\",");
        ...
        if (isFilter) {
            stringBuffer.append(" and rownum<=100");
        }
        return stringBuffer;
    }
