...
public class OutinterfaceModelAndMetaDataDTO {
    ...
    private List<OutinterfaceBasicModelAndMetaDataDTO> businessModelMetaDataDTOS;
    ...
    public List<OutinterfaceBasicModelAndMetaDataDTO> getBusinessModelMetaDataDTOS() {
        return businessModelMetaDataDTOS;
    }

    public void setBusinessModelMetaDataDTOS(List<OutinterfaceBasicModelAndMetaDataDTO> businessModelMetaDataDTOS) {
