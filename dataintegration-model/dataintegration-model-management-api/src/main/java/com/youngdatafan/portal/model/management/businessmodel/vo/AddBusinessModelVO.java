...
public class AddBusinessModelVO {
    ...
    public List<BasicModelMetaDataCopyDTO> getBasicModelMetaDataCopyDTOS() {
        return basicModelMetaDataCopyDTOS;
    }

    public void setBasicModelMetaDataCopyDTOS(List<BasicModelMetaDataCopyDTO> basicModelMetaDataCopyDTOS) {
