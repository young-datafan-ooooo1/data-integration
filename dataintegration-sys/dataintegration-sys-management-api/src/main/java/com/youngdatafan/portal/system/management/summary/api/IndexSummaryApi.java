...
public interface IndexSummaryApi {
    ...
    Result<MonSumDTO, Object> selectProjectSumMonth(@ApiParam("操作用户Id") @RequestHeader("authorization-userId") String userId, @ApiParam("项目类别（TSJB:探索脚本，JCJB：集成脚本）") @RequestParam("projectType") String projectType);
