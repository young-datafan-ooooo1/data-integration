...
public interface ProjectServiceApi {
    ...
    Result<String, Object> add(@Validated @RequestBody ProjectAddVO groupAddVO
    ...
    Result<String, Object> updateSelective(@Validated @RequestBody ProjectUpdateVO projectUpdateVO
            , @RequestHeader(value = "authorization-userId") String userId, @RequestHeader(value = "authorization-userName") String userName);
